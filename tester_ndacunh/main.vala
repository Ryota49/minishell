...
public int g_timeout = 4000; // 4 seconds
...
class Main {
	...
	const OptionEntry[] options = {
		...
		{ "timeout", 't', OptionFlags.NONE, OptionArg.INT, ref g_timeout, "set the timeout for each test in milliseconds default: 4000 (4 seconds)", "timeout in ms"},
